<script lang="ts">
	...
	export let data: { posts: { post: Post; post_id: string }[]; currentUser: User | null };
...
<svelte:head>
	...
	<meta
		name="description"
		content="Writtr is a website where you can post articles easily. Create an account to post content."
	/>
</svelte:head>
